...
use App\Http\Requests\Admin\ZDurationRequest;
...
/**
 * Class ZDurationController
 * @package App\Http\Controllers\Admin
 *
 * @property ZDuration $model
 */
class ZDurationController extends BaseController
{
    use HasLocaleTrait;
    ...
    {
        $this->model = new ZDuration();
        $this->slug = 'z_durations';
    }
    ...
    public function store(ZDurationRequest $request)
    {
        try {
    ...
    public function update(ZDurationRequest $request, $id)
    {
        try {
            if (!$data = $this->model::getById($id)) {
                return abort(Helper::HTTP_NOT_FOUND);
