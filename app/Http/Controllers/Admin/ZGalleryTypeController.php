 ...
 * @property ZGalleryType $model
 */
class ZGalleryTypeController extends BaseController
{
    use HasLocaleTrait;
    ...
    {
        $this->model = new ZGalleryType();
        $this->slug = 'z_gallery_types';
    }
    ...
    {
        $data = $this->model;
        $zGalleryTypes = $this->model::getList();
    ...
    public function store(ZGalleryTypeRequest $request)
    {
        try {
    ...
    public function update(ZGalleryTypeRequest $request, $id)
    {
        try {
            if (!$data = $this->model::getById($id)) {
                return abort(Helper::HTTP_NOT_FOUND);
