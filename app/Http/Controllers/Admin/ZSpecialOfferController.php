...
use App\Http\Requests\Admin\ZSpecialOfferRequest;
...
/**
 * Class ZSpecialOfferController
 * @package App\Http\Controllers\Admin
 *
 * @property ZSpecialOffer $model
 */
class ZSpecialOfferController extends BaseController
{
    use HasLocaleTrait;
    ...
    {
        $this->model = new ZSpecialOffer();
        $this->slug = 'z_special_offers';
    }
    ...
    public function store(ZSpecialOfferRequest $request)
    {
        try {
    ...
    public function update(ZSpecialOfferRequest $request, $id)
    {
        try {
            if (!$data = $this->model::getById($id)) {
                return abort(Helper::HTTP_NOT_FOUND);
