...
use App\Http\Requests\Admin\ZOfferRequest;
...
/**
 * Class ZOfferController
 * @package App\Http\Controllers\Admin
 *
 * @property ZOffer $model
 */
class ZOfferController extends BaseController
{
    use HasLocaleTrait;
    ...
    public function store(ZOfferRequest $request)
    {
        try {
    ...
    public function update(ZOfferRequest $request, $id)
    {
        try {
            if (!$data = $this->model::getById($id)) {
                return abort(Helper::HTTP_NOT_FOUND);
