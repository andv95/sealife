...
use App\Http\Requests\Admin\ZDistributorsRequest;
use App\Models\ZDistributor;
use Illuminate\Http\Request;
use Yajra\DataTables\Facades\DataTables;
use Throwable;

/**
 * Class ZDistributorController
 * @package App\Http\Controllers\Admin
 *
 * @property ZDistributor $model
 */
class ZDistributorController extends BaseController
{
    use HasLocaleTrait;
    ...
    {
        $this->model = new ZDistributor();
        $this->slug = 'z_distributors';
    }
    ...
    public function store(ZDistributorsRequest $request)
    {
        try {
    ...
    public function update(ZDistributorsRequest $request, $id)
    {
        try {
            if (!$data = $this->model::getById($id)) {
                return abort(Helper::HTTP_NOT_FOUND);
