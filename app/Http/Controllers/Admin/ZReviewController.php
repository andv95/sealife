...
use App\Http\Requests\Admin\ZReviewControllerRequest;
...
/**
 * Class ZReviewController
 * @package App\Http\Controllers\Admin
 *
 * @property ZReview $model
 */
class ZReviewController extends BaseController
{
    use HasLocaleTrait;
    ...
    public function store(ZReviewControllerRequest $request)
    {
        try {
    ...
    public function update(ZReviewControllerRequest $request, $id)
    {
        try {
            if (!$data = $this->model::getById($id)) {
                return abort(Helper::HTTP_NOT_FOUND);
